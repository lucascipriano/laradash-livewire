        ...
        <div :class="{ '!translate-x-0': open }"
                ...
                <div class="inline-flex items-center justify-center w-full md:justify-center">
                    ...
                    <a href="#" @click="open = !open"
                       class="absolute right-0 top-0 mr-1.5 mt-1.5 inline-flex p-1 items-center justify-center rounded-md hover:bg-blue-100 md:hidden">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 stroke-blue-600" fill="none"
                             viewBox="0 0 24 24"
            ...
            <div class="divide-y divide-gray-100 divide-solid">
                <div class="p-5 text-center">
                    <div class="flex items-center justify-center py-2 px-2 w-full ">
                        <div class="flex shrink-0 items-center justify-center">
                            {{-- <x-mdi-laravel class="block h-8 fill-current text-red-500 dark:text-gray-200"/> --}}
                            <div>
                                <svg viewBox="-4 0 264 264" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid" class="block h-8 fill-current text-red-500 dark:text-gray-200"
                                     fill="none"
                                     stroke="currentColor" stroke-width="2">
                                    <g>
                            ...
                            <div class="flex flex-col pl-2">
                                <span class="text-sm font-semibold">DashLaravel</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex flex-col mb-0 ml-0">
                <x-sidebar-nav-link :href="route('dashboard')" wire:navigate :active="request()->routeIs('dashboard')">
                    <x-slot name="icon">
                ...
                <x-sidebar-nav-link :href="route('clientes')" wire:navigate :active="request()->routeIs('clientes')">
                    <x-slot name="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 mr-4" fill="none" viewBox="0 0 24 24"
                             stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <x-sidebar-nav-link :href="route('settings')" wire:navigate :active="request()->routeIs('settings')">
                    <x-slot name="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 mr-4" fill="none" viewBox="0 0 24 24"
                             stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round"
